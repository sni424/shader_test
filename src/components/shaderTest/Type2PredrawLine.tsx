...
const positions: [number, number, number, number, number, number][] = [
    [0.830, 2.400, 2.026,
        0.830, 0, 2.026],
    [1.1715, 1.196, 2.013, -3.808, 1.196, 2.013],
    [0.756, 0.1, 1.0477, 0.756, 0.1, 4.73],
];
...
const Type2PredrawLine = ({ dimensionsClick, room }: { dimensionsClick: boolean, room: string }) => {
                ...
                return (
                    <React.Fragment key={`line_${index}`}>
                        <Sphere
                            ...
                            renderOrder={999}
                        >
                            <meshStandardMaterial color="white" depthTest={false} depthWrite={false} />
                        </Sphere>



                        <Line
                            points={[[child[0], child[1], child[2]], [child[3], child[4], child[5]]]}
                            color="white"
                            lineWidth={2}
                            renderOrder={999}
                            segments
...
export default Type2PredrawLine