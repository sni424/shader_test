...
const modelGlb = null
const CheckLightMap = ({ isClick }: { isClick: boolean }) => {
        ...
        gltfScene.traverse((child) => {
            if (child.isMesh && child.name === "바닥") {
                ...
                clonedMat.onBeforeCompile = (shader) => {
                    ...
                    shader.uniforms.lightMapStrength = { value: 0.4 };
